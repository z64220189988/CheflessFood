...
namespace 個人專題Chefless_Food__Decentralization
{
    public partial class HOME : UIForm
    {
        ...
        private void btn達人接案平台_發佈徵才_Click(object sender, EventArgs e)
        {
            Form發佈徵才 formCMWTP = new Form發佈徵才();
            formCMWTP.ShowDialog();
        }
        ...
        private void cbox達人接案平台_排序選項_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void txt訂單管理_關鍵字_TextChanged(object sender, EventArgs e)
        {

        }

        private void btn訂單管理_依據_Click(object sender, EventArgs e)
        {

        }

        private void cbox訂單管理_依據_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void DataGridView訂單管理_顯示訂單_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void txt會員管理_關鍵字_TextChanged(object sender, EventArgs e)
        {

        }

        private void btn會員管理_依據_Click(object sender, EventArgs e)
        {

        }

        private void cbox會員管理_依據_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void btn會員管理_刪除_Click(object sender, EventArgs e)
        {

        }

        private void btn會員管理_多選_Click(object sender, EventArgs e)
        {
        ...
        private void btn會員管理_修改客戶個資_Click(object sender, EventArgs e)
        {
        ...
        private void lbl會員管理_查詢的會員帳號為_Click(object sender, EventArgs e)
        {

        }

        private void lbl會員管理_歷史訂單_Click(object sender, EventArgs e)
        {

        }

        private void DataGridView會員管理_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void lbl打卡_你的員工帳號_Click(object sender, EventArgs e)
        {

        }

        private void cbox打卡_你的員工帳號_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lbl打卡_密碼_Click(object sender, EventArgs e)
        {

        }

        private void txt打卡_密碼_TextChanged(object sender, EventArgs e)
        {

        }

        private void lbl打卡_現在時間_Click(object sender, EventArgs e)
        {
        ...
        private void DataGridView打卡紀錄_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void txt權限修改_Email1_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt權限修改_密碼1_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt權限修改_姓名1_TextChanged(object sender, EventArgs e)
        {

        }

        private void cbox權限修改_身分組1_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void txt權限修改_Email2_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt權限修改_密碼2_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt權限修改_身分組2_TextChanged(object sender, EventArgs e)
        {
        ...
        private void cbox系統維護_維護開始時間_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void cbox系統維護_維護結束時間_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void lbl系統維護_圖檔路徑為_Click(object sender, EventArgs e)
        {
